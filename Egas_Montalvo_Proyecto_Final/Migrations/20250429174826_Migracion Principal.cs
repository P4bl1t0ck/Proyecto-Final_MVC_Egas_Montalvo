        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Producto_Usuario_ProveedorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pago_Transaccion_TransaccionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrasaccionProducto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrasaccionProducto_Producto_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Producto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrasaccionProducto_Transaccion_TransaccionId",
                        column: x => x.TransaccionId,
                        principalTable: "Transaccion",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrasaccionProducto_ProductoId",
                table: "TrasaccionProducto",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_TrasaccionProducto_TransaccionId",
                table: "TrasaccionProducto",
                column: "TransaccionId");
        }
